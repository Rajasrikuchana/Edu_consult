...
public class ContactusService {
    ...
    public ContactPageResponseDTO getAllContactus(int page, int size, String sortBy, String order){
        ...
        return ContactPageResponseDTO.builder()
                .success(true)
                .data(contactUsPage.getContent().stream().map(ContactusMapper::toResponseDTO).toList())
                .totalElements(contactUsPage.getTotalElements())
                .totalPages(contactUsPage.getTotalPages())
                .pageSize(contactUsPage.getSize())
                .currentPage(contactUsPage.getNumber())
                .hasNext(contactUsPage.hasNext())
                .hasPrevious(contactUsPage.hasPrevious())
                .build();
    }
}
