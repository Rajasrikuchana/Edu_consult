...
const AdminSignin = () => {
	return (
		<Layout>
			<div className="min-h-[89vh] bg-gray-400 py-6 flex flex-col justify-center sm:py-12">
								...
								<div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
									<div className="relative">
										<input
											...
											name="email"
											type="text"
											className="peer rounded-md placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600"
