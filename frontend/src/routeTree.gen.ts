...
import { Route as LayoutTagsIdBlogsImport } from './routes/_layout/tags/$id.blogs'
import { Route as AdminAdminTagsEditImport } from './routes/_admin/admin/tags/edit'
import { Route as AdminAdminTagsCreateImport } from './routes/_admin/admin/tags/create'
import { Route as AdminAdminFeedbackIdImport } from './routes/_admin/admin/feedback/$id'
import { Route as AdminAdminCoursesCreateImport } from './routes/_admin/admin/courses/create'
...
import { Route as AdminAdminBlogsCreateImport } from './routes/_admin/admin/blogs/create'
import { Route as AdminAdminCoursesEditIdImport } from './routes/_admin/admin/courses/edit.$id'
import { Route as AdminAdminCategoriesEditIdImport } from './routes/_admin/admin/categories/edit.$id'
import { Route as AdminAdminBlogsEditIdImport } from './routes/_admin/admin/blogs/edit.$id'
...
const LayoutTagsIdBlogsRoute = LayoutTagsIdBlogsImport.update({
  id: '/tags/$id/blogs',
  path: '/tags/$id/blogs',
  getParentRoute: () => LayoutRoute,
} as any)

const AdminAdminTagsEditRoute = AdminAdminTagsEditImport.update({
  id: '/admin/tags/edit',
  path: '/admin/tags/edit',
  getParentRoute: () => AdminRoute,
} as any)

const AdminAdminTagsCreateRoute = AdminAdminTagsCreateImport.update({
...
const AdminAdminCoursesCreateRoute = AdminAdminCoursesCreateImport.update({
...
const AdminAdminBlogsCreateRoute = AdminAdminBlogsCreateImport.update({
  id: '/admin/blogs/create',
  path: '/admin/blogs/create',
  getParentRoute: () => AdminRoute,
} as any)

const AdminAdminCoursesEditIdRoute = AdminAdminCoursesEditIdImport.update({
  id: '/admin/courses/edit/$id',
  path: '/admin/courses/edit/$id',
  getParentRoute: () => AdminRoute,
} as any)

const AdminAdminCategoriesEditIdRoute = AdminAdminCategoriesEditIdImport.update(
  {
...
const AdminAdminBlogsEditIdRoute = AdminAdminBlogsEditIdImport.update({
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_admin/admin/blogs/create': {
      id: '/_admin/admin/blogs/create'
      path: '/admin/blogs/create'
      fullPath: '/admin/blogs/create'
      preLoaderRoute: typeof AdminAdminBlogsCreateImport
      parentRoute: typeof AdminImport
    }
    ...
    '/_admin/admin/courses/create': {
      ...
      preLoaderRoute: typeof AdminAdminCoursesCreateImport
      parentRoute: typeof AdminImport
    }
    ...
    '/_admin/admin/tags/create': {
      id: '/_admin/admin/tags/create'
      path: '/admin/tags/create'
      fullPath: '/admin/tags/create'
      preLoaderRoute: typeof AdminAdminTagsCreateImport
      parentRoute: typeof AdminImport
    }
    '/_admin/admin/tags/edit': {
      id: '/_admin/admin/tags/edit'
      path: '/admin/tags/edit'
      fullPath: '/admin/tags/edit'
      preLoaderRoute: typeof AdminAdminTagsEditImport
      parentRoute: typeof AdminImport
    }
    '/_layout/tags/$id/blogs': {
      id: '/_layout/tags/$id/blogs'
      path: '/tags/$id/blogs'
      fullPath: '/tags/$id/blogs'
      preLoaderRoute: typeof LayoutTagsIdBlogsImport
      parentRoute: typeof LayoutImport
    }
    '/_admin/admin/blogs/': {
    ...
    '/_admin/admin/blogs/edit/$id': {
      id: '/_admin/admin/blogs/edit/$id'
      path: '/admin/blogs/edit/$id'
      fullPath: '/admin/blogs/edit/$id'
      preLoaderRoute: typeof AdminAdminBlogsEditIdImport
      parentRoute: typeof AdminImport
    }
    '/_admin/admin/categories/edit/$id': {
      id: '/_admin/admin/categories/edit/$id'
      path: '/admin/categories/edit/$id'
      fullPath: '/admin/categories/edit/$id'
      preLoaderRoute: typeof AdminAdminCategoriesEditIdImport
      parentRoute: typeof AdminImport
    }
    '/_admin/admin/courses/edit/$id': {
      id: '/_admin/admin/courses/edit/$id'
      path: '/admin/courses/edit/$id'
      fullPath: '/admin/courses/edit/$id'
      preLoaderRoute: typeof AdminAdminCoursesEditIdImport
      parentRoute: typeof AdminImport
    }
  }
}
...
interface AdminRouteChildren {
  ...
  AdminAdminBlogsCreateRoute: typeof AdminAdminBlogsCreateRoute
  AdminAdminCategoriesCreateRoute: typeof AdminAdminCategoriesCreateRoute
  ...
  AdminAdminTagsCreateRoute: typeof AdminAdminTagsCreateRoute
  AdminAdminTagsEditRoute: typeof AdminAdminTagsEditRoute
  ...
  AdminAdminCoursesEditIdRoute: typeof AdminAdminCoursesEditIdRoute
}
...
const AdminRouteChildren: AdminRouteChildren = {
  ...
  AdminAdminBlogsCreateRoute: AdminAdminBlogsCreateRoute,
  AdminAdminCategoriesCreateRoute: AdminAdminCategoriesCreateRoute,
  ...
  AdminAdminTagsCreateRoute: AdminAdminTagsCreateRoute,
  AdminAdminTagsEditRoute: AdminAdminTagsEditRoute,
  ...
  AdminAdminCoursesEditIdRoute: AdminAdminCoursesEditIdRoute,
}
...
interface LayoutRouteChildren {
  ...
  LayoutTagsIdBlogsRoute: typeof LayoutTagsIdBlogsRoute
}
...
const LayoutRouteChildren: LayoutRouteChildren = {
  ...
  LayoutTagsIdBlogsRoute: LayoutTagsIdBlogsRoute,
}
...
export interface FileRoutesByFullPath {
  ...
  '/admin/blogs/create': typeof AdminAdminBlogsCreateRoute
  '/admin/categories/create': typeof AdminAdminCategoriesCreateRoute
  ...
  '/admin/tags/create': typeof AdminAdminTagsCreateRoute
  '/admin/tags/edit': typeof AdminAdminTagsEditRoute
  '/tags/$id/blogs': typeof LayoutTagsIdBlogsRoute
  ...
  '/admin/categories/edit/$id': typeof AdminAdminCategoriesEditIdRoute
  '/admin/courses/edit/$id': typeof AdminAdminCoursesEditIdRoute
}
...
export interface FileRoutesById {
  ...
  '/_admin/admin/blogs/create': typeof AdminAdminBlogsCreateRoute
  '/_admin/admin/categories/create': typeof AdminAdminCategoriesCreateRoute
  ...
  '/_admin/admin/tags/create': typeof AdminAdminTagsCreateRoute
  '/_admin/admin/tags/edit': typeof AdminAdminTagsEditRoute
  '/_layout/tags/$id/blogs': typeof LayoutTagsIdBlogsRoute
  ...
  '/_admin/admin/categories/edit/$id': typeof AdminAdminCategoriesEditIdRoute
  '/_admin/admin/courses/edit/$id': typeof AdminAdminCoursesEditIdRoute
}
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_admin/admin/blogs/create": {
      "filePath": "_admin/admin/blogs/create.tsx",
      "parent": "/_admin"
    },
    "/_admin/admin/categories/create": {
    ...
    "/_admin/admin/courses/create": {
      "filePath": "_admin/admin/courses/create.tsx",
      "parent": "/_admin"
    },
    "/_admin/admin/feedback/$id": {
    ...
    "/_admin/admin/tags/create": {
      "filePath": "_admin/admin/tags/create.tsx",
      "parent": "/_admin"
    },
    "/_admin/admin/tags/edit": {
      "filePath": "_admin/admin/tags/edit.tsx",
      "parent": "/_admin"
    },
    "/_layout/tags/$id/blogs": {
      "filePath": "_layout/tags/$id.blogs.tsx",
      "parent": "/_layout"
    },
    "/_admin/admin/blogs/": {
    ...
    "/_admin/admin/blogs/edit/$id": {
      "filePath": "_admin/admin/blogs/edit.$id.tsx",
      "parent": "/_admin"
    },
    "/_admin/admin/categories/edit/$id": {
      "filePath": "_admin/admin/categories/edit.$id.tsx",
      "parent": "/_admin"
    },
    "/_admin/admin/courses/edit/$id": {
      "filePath": "_admin/admin/courses/edit.$id.tsx",
      "parent": "/_admin"
    }
  }
}
